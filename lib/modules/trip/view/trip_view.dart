      ...
      body: SingleChildScrollView(
        ...
        child: Column(children: [
          ...
          trip.status != 'finished'
              ? Padding(
                  padding: const EdgeInsets.only(
                      bottom: AppPaddings.verticalPaddingBetween),
                  child: GetBuilder<TripController>(builder: (tripController) {
                    return CustomButton(
                      buttonTextLabel: trip.status == 'not_yet'
                          ? 'start_trip'.tr
                          : 'end_trip'.tr,
                      onClick: () {
                        Get.defaultDialog(
                            title: trip.status == 'not_yet'
                                ? 'start_trip'.tr
                                : 'end_trip'.tr,
          ...
          TripListTile(
            ...
            title: '${"bus_number".tr} : ${trip.busId}',
          ),
          TripListTile(
            iconData: Icons.group,
            title: '${'passenger_count'.tr} : ${trip.passengerAvailable}',
          ),
          TripListTile(
            ...
            onPressed: () async {
              ...
              var lat = location.substring(
                  location.indexOf('', 0), location.lastIndexOf(','));
